...
namespace MZ_MES_MAIN.Wrap
{
    ...
    public class ProductionOrderDeliveryWrap
    {
        /// <summary>
        /// 生产订单号
        /// </summary>
        ...
        /// 订单明细
        /// </summary>
        [XmlElementAttribute("ITEM", IsNullable = false, Type = typeof(ProductionOrderDeliveryDetailWrap), Order = 7)]
        public ProductionOrderDeliveryDetailWrap[] DeliveryDetail = null;
    }

    public class ProductionOrderDeliveryDetailWrap
    { 
        /// <summary>
        /// 行项目
        /// </summary>
