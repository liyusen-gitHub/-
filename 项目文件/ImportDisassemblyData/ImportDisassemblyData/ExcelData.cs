...
namespace ImportDisassemblyData
{
    ...
    public abstract class MianqiCabinetToSQL
    {
        ...
        void CreateMianqiCabinetToSQL()
        {
            ...
            A6MianQiXialiaodan_Table2.Columns.Add("FLong", typeof(float));//完工高
            ...
            A6MianQiXialiaodan_Table2.Columns.Add("CutLong", typeof(float));//下料宽
            ...
            XiSuMenbanXialiaodan_Table.Columns.Add("FLong", typeof(float));//完工高
            ...
            XiSuMenbanXialiaodan_Table.Columns.Add("CutLong", typeof(float));//下料数量
