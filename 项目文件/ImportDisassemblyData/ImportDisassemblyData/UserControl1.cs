...
namespace ImportDisassemblyData
{
    public partial class UserControl1 : UserControl
    {
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            ...
            string ProductOrderNo = this.dataGridView1.SelectedRows[0].Cells[1].Value.ToString();

            string ProductOrderNo1 = "";
            ProductOrderNo1= this.txtFilePath.Text.Substring(this.txtFilePath.Text.LastIndexOf(".")-10).Replace(".xlsx","");
            if (ProductOrderNo == ProductOrderNo1)
            {
                //return;
            ...
            {
                MessageBox.Show("导入的文件与选择的订单不匹配！！！");
                return;
            }
