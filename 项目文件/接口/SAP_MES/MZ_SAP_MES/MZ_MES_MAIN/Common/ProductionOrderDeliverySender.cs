...
{
    public class ProductionOrderDeliverySender
    {
                        private String endPointName = "binding_SOAP12";
        private String user = String.Empty;
        private String _syncName = String.Empty;
 
        public ProductionOrderDeliverySender(String user)
        {
            this.user = user;
        }
        public ProductionOrderDeliverySender(String user, String syncName)
        {
