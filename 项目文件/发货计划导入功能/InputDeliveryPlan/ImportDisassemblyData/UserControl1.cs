    ...
    public partial class UserControl1 : UserControl
    {
            ...
            if (System.IO.File.Exists(Path) == true)
            {
                ...
                using (ExcelPackage pck = new ExcelPackage(FS))
                {
                    ...
                    try
                    {
                        ...
                        sheet = pck.Workbook.Worksheets["发货计划"];
                        if (sheet.Hidden.ToString() == "Visible")
                        {
                            ...
                            if (Convert.ToString(sheet.Hidden) != "Hidden")
                            {
                                ...
                                Table1.Columns.Add("SerialNumber");
                                Table1.Columns.Add("City");
                                Table1.Columns.Add("CustomerName");
                                Table1.Columns.Add("OrderType");
                                Table1.Columns.Add("ProductOrderNo");
                                Table1.Columns.Add("InTime");
                                Table1.Columns.Add("Num");
                                Table1.Columns.Add("Cubic");
                                Table1.Columns.Add("Payment");
                                Table1.Columns.Add("CarID");
                                Table1.Columns.Add("ReMark");
                                Table1.Columns.Add("Remark2");
                                ...
                                for (int i = sRowNum; i < eRowNum; i++)
                                {
                                    ...
                                    for (int j = 1; j < 13; j++)
                                    {
                                        ...
                                        {
                                            case 1:
                                                GuitiIssueMaterialBillsDataTableRow["SerialNumber"] = CellValue;
                                                break;
                                            case 2:
                                                GuitiIssueMaterialBillsDataTableRow["City"] = CellValue;
                                                break;
                                            case 3:
                                                GuitiIssueMaterialBillsDataTableRow["CustomerName"] = CellValue;

                                                break;
                                            case 4:
                                                GuitiIssueMaterialBillsDataTableRow["OrderType"] = CellValue;
                                                break;
                                            case 5:
                                                GuitiIssueMaterialBillsDataTableRow["ProductOrderNo"] = CellValue;
                                                break;
                                            case 6:
                                                GuitiIssueMaterialBillsDataTableRow["InTime"] = CellValue;
                                                break;
                                            case 7:
                                                GuitiIssueMaterialBillsDataTableRow["Num"] = CellValue;
                                                break;
                                            case 8:
                                                GuitiIssueMaterialBillsDataTableRow["Cubic"] = CellValue;
                                                break;
                                            case 9:
                                                GuitiIssueMaterialBillsDataTableRow["Payment"] = CellValue;
                                                break;
                                            case 10:
                                                GuitiIssueMaterialBillsDataTableRow["CarID"] = CellValue;
                                                break;
                                            case 11:
                                                GuitiIssueMaterialBillsDataTableRow["ReMark"] = CellValue;
                                                break;
                                            case 12:
                                                GuitiIssueMaterialBillsDataTableRow["ReMark2"] = CellValue;
                                                break;
                                        }
                                    }
                                ...
                                TableCopy.DestinationTableName = "DeliveryPlan";
      ...
      //                                  }
        ...
        void ImportExcelData(string Path, string ParentId)
        {
            ...
            ImportDisassemblyData.QuickBeautyFreePaintDoorSheetExcelData QuickBeautyFreePaintDoorSheetObj = null;

            ImportDisassemblyData.NoPaintDoorSheetExcelData NoPaintDoorSheetExcelDataObj = null;
            //吸塑模板
            ...
            ImportDisassemblyData.ClothesClosetMaterialListToSQL ClothesClosetMaterialObj = null;
